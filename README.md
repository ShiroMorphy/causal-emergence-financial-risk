...
- **Low-Dimensional Concentration:** Systemic liquidity/contagion crises concentrate causal dynamics into lower macro-dimensions (combined modal $q^* = 2$, with 80.8% of trading days having $q^* \le 4$), whereas valuation repricing episodes (such as the 2000 Dot-Com crash and 2022 rate tightening) disperse across higher dimensions (modal $q^* = 4$, with 48.9% having $q^* \le 4$).
