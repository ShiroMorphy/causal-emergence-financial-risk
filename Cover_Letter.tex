...
\begin{itemize}\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\setlength{\parsep}{0pt}
    \item \textbf{State-Dependent Emergence:} Across historical stress episodes, observed emergence significantly exceeds static correlation and cross-lag isolation nulls ($p_{\text{Holm}} \le 0.0396$).
    ...
    \item \textbf{Dimensionality Concentration:} Systemic stress dynamically concentrates causal transitions into low macroscopic dimensions ($q^* \le 2$ in over 93\% of historical windows, modal $q^* = 2$).
\end{itemize}
